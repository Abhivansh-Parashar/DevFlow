...
import { Bell, GitCommit, AtSign, Tag, MessageSquare, Check, CheckCheck } from 'lucide-react';
                ...
                notifications.map((n) => {
                  ...
                  return (
                    <button
                      key={n.id}
                      onClick={() => openIssue(n)}
                      className={cx('focus-ring flex w-full items-start gap-3 border-b border-line px-4 py-3 text-left transition-colors last:border-0 hover:bg-raised')}
