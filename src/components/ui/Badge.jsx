...
export function Badge({ variant = 'neutral', size = 'sm', dot = false, className, children }) {
  return (
    <span className={cx('badge', VARIANTS[variant] ?? VARIANTS.neutral, SIZES[size], className)}>
      {dot && (
        <span
