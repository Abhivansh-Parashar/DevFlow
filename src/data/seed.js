...
export const seedProjects = [
  { id: 'p1', workspaceId: 'ws1', name: 'Frontend', description: 'Product UI, design system and the pipeline board.', repoUrl: 'https://github.com/microsoft/vscode', localRepoPath: 'C:/Users/abhiv/OneDrive/Documents/demo2', ideUrl: 'vscode://file/C:/Users/abhiv/OneDrive/Documents/demo2', color: '#009E88', icon: '#', keyPrefix: 'DEV', memberIds: ['u1', 'u2', 'u3', 'u4'], roles: { u1: 'Owner', u2: 'Member', u3: 'Member', u4: 'Member' } },
  { id: 'p2', workspaceId: 'ws1', name: 'Backend', description: 'APIs, auth and the realtime gateway.', repoUrl: 'https://github.com/nodejs/node', localRepoPath: 'C:/Users/abhiv/OneDrive/Documents/demo2', ideUrl: 'vscode://file/C:/Users/abhiv/OneDrive/Documents/demo2', color: '#7C6AE8', icon: '#', keyPrefix: 'API', memberIds: ['u1', 'u2', 'u5', 'u6'], roles: { u1: 'Owner', u2: 'Member', u5: 'Member', u6: 'Member' } },
  { id: 'p3', workspaceId: 'ws1', name: 'DevOps', description: 'CI/CD, observability and release tooling.', repoUrl: 'https://github.com/actions/runner', localRepoPath: 'C:/Users/abhiv/OneDrive/Documents/demo2', ideUrl: 'vscode://file/C:/Users/abhiv/OneDrive/Documents/demo2', color: '#FFB454', icon: '#', keyPrefix: 'OPS', memberIds: ['u1', 'u3', 'u6'], roles: { u1: 'Owner', u3: 'Member', u6: 'Member' } },
  { id: 'p4', workspaceId: 'ws2', name: 'Mobile', description: 'iOS & Android client with offline-first sync.', repoUrl: 'https://github.com/facebook/react-native', localRepoPath: 'C:/Users/abhiv/OneDrive/Documents/demo2', ideUrl: 'vscode://file/C:/Users/abhiv/OneDrive/Documents/demo2', color: '#FF6B6B', icon: '#', keyPrefix: 'MOB', memberIds: ['u1', 'u7', 'u8'], roles: { u7: 'Owner', u8: 'Member', u1: 'Member' } },
  { id: 'p5', workspaceId: 'ws2', name: 'Data Platform', description: 'Lakehouse catalog, pipelines and query layer.', repoUrl: 'https://github.com/apache/spark', localRepoPath: 'C:/Users/abhiv/OneDrive/Documents/demo2', ideUrl: 'vscode://file/C:/Users/abhiv/OneDrive/Documents/demo2', color: '#3B82F6', icon: '#', keyPrefix: 'DTA', memberIds: ['u7', 'u8', 'u9'], roles: { u7: 'Owner', u8: 'Member', u9: 'Member' } },
  // Brand new project — Ada is invited but not yet a member.
  { id: 'p6', workspaceId: 'ws1', name: 'Design System', description: 'Token architecture, component library and living docs.', repoUrl: '', localRepoPath: '', ideUrl: '', color: '#EC4899', icon: '#', keyPrefix: 'DSN', memberIds: ['u3'], roles: { u3: 'Owner' } },
];
